...
import { N as NodeApp, g as deserializeManifest } from './chunks/astro.909781ac.mjs';
...
const _page0  = () => import('./chunks/index@_@astro.bbc15886.mjs');
const _page1  = () => import('./chunks/example@_@ts.37ad0053.mjs');const pageMap = new Map([["src/pages/index.astro", _page0],["src/pages/api/example.ts", _page1]]);
const _manifest = Object.assign(deserializeManifest({"adapterName":"@astrojs/node","routes":[{"file":"index.html","links":[],"scripts":[],"styles":[],"routeData":{"route":"/","type":"page","pattern":"^\\/$","segments":[],"params":[],"component":"src/pages/index.astro","pathname":"/","prerender":true,"_meta":{"trailingSlash":"ignore"}}},{"file":"","links":[],"scripts":[],"styles":[],"routeData":{"route":"/api/example","type":"endpoint","pattern":"^\\/api\\/example$","segments":[[{"content":"api","dynamic":false,"spread":false}],[{"content":"example","dynamic":false,"spread":false}]],"params":[],"component":"src/pages/api/example.ts","pathname":"/api/example","prerender":false,"_meta":{"trailingSlash":"ignore"}}}],"base":"/","compressHTML":false,"markdown":{"drafts":false,"syntaxHighlight":"shiki","shikiConfig":{"langs":[],"theme":"github-dark","wrap":false},"remarkPlugins":[],"rehypePlugins":[],"remarkRehype":{},"gfm":true,"smartypants":true},"componentMetadata":[["/Users/antoncherepov/Development/repros/astro-node-repro/src/pages/index.astro",{"propagation":"none","containsHead":true}]],"renderers":[],"clientDirectives":[["idle","(()=>{var i=t=>{let e=async()=>{await(await t())()};\"requestIdleCallback\"in window?window.requestIdleCallback(e):setTimeout(e,200)};(self.Astro||(self.Astro={})).idle=i;window.dispatchEvent(new Event(\"astro:idle\"));})();"],["load","(()=>{var e=async t=>{await(await t())()};(self.Astro||(self.Astro={})).load=e;window.dispatchEvent(new Event(\"astro:load\"));})();"],["media","(()=>{var s=(i,t)=>{let a=async()=>{await(await i())()};if(t.value){let e=matchMedia(t.value);e.matches?a():e.addEventListener(\"change\",a,{once:!0})}};(self.Astro||(self.Astro={})).media=s;window.dispatchEvent(new Event(\"astro:media\"));})();"],["only","(()=>{var e=async t=>{await(await t())()};(self.Astro||(self.Astro={})).only=e;window.dispatchEvent(new Event(\"astro:only\"));})();"],["visible","(()=>{var r=(s,c,i)=>{let o=async()=>{await(await s())()},n=new IntersectionObserver(e=>{for(let t of e)if(t.isIntersecting){n.disconnect(),o();break}});for(let e=0;e<i.children.length;e++){let t=i.children[e];n.observe(t)}};(self.Astro||(self.Astro={})).visible=r;window.dispatchEvent(new Event(\"astro:visible\"));})();"]],"entryModules":{"\u0000@astrojs-ssr-virtual-entry":"_@astrojs-ssr-virtual-entry.mjs","\u0000@astro-renderers":"renderers.mjs","\u0000empty-middleware":"_empty-middleware.mjs","/src/pages/api/example.ts":"chunks/pages/example.ts.29cd7662.mjs","/src/pages/index.astro":"chunks/prerender.e251b58d.mjs","\u0000@astro-page:src/pages/index@_@astro":"chunks/index@_@astro.bbc15886.mjs","\u0000@astro-page:src/pages/api/example@_@ts":"chunks/example@_@ts.37ad0053.mjs","astro:scripts/before-hydration.js":""},"assets":["/_astro/index.39048fa7.css","/favicon.svg","/index.html"]}), {
	pageMap,
	renderers,
});
const _args = {"mode":"standalone","client":"file:///Users/antoncherepov/Development/repros/astro-node-repro/dist/client/","server":"file:///Users/antoncherepov/Development/repros/astro-node-repro/dist/server/","host":false,"port":3000};
